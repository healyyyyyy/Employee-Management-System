...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        f = new JFrame("Pearson Specter Litt - Add Employee");
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("EMS/images/add.jpg"));     // background image from local file
        id15.setIcon(img);

        // create and place labels
        id8 = new JLabel("New Employee Record");
